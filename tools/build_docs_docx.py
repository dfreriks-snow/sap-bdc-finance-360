#!/usr/bin/env python3
"""Render the Finance 360 markdown documentation set as branded Word documents.
...
Ported from supply_chain_ontology_react/tools/build_docs_docx.py. The rendering
behaviour is deliberately identical; only SOURCES, the output directory and the
cover strapline differ.
"""
...
def build_handbook():
    ...
    out = OUT / "SAP_Finance_360_Documentation_Handbook.docx"
    doc.save(out)
    return out
