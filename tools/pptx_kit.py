...
The implementation lives once, versioned with this repo, at

    sap-bdc-finance-360/tools/sap_pptx_kit.py

It was extracted from supply_chain_demo_2026/deck/pptx_kit.py so the Finance and
Sales decks reuse the same helpers and the same slide verifiers, rather than a
